...
namespace Талончик
{
    public partial class Form2 : Form
    {
        ...
        private void Form2_Load(object sender, EventArgs e)
        {
            try
            {
                tabControl2.DrawItem += Methods.TabControl_DrawItem;
                ...
                {
                    if (specialitydoc.SelectedIndex >= 0) DoctorNameData(specialitydoc.SelectedItem.ToString());
                    dayTab1.ClearB();
                    dayTab1.SelectedDay = "";
                };
                ...
                else
                {
                   ...
                   MessageBoxDefaultButton.Button1);
                    if (ress == DialogResult.Yes)
                    {
                        ...
                        string zpsday = "";
                        List<string> zapislsit = new List<string>();
                        foreach (var zap in zapises)
                        {
        ...
        public void MyZapis()
        {
            ...
            if (zapis.Count() != 0)
            {
                foreach (var zps in zapis)
                {
                    ...
                    switch (zps.ZapisDate.ToLocalTime().CompareTo(DateTime.Now.ToLocalTime()))
                    {
                        case 0:
                            {
